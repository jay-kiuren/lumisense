...
import 'analytics_range_selector.dart';
...
class DepartmentDetailView extends StatelessWidget {
                ...
                Expanded(
                  ...
                  child: Column(
                    children: [
                      ...
                      Expanded(
                        flex: 3,
                        child: _buildRealtimeChart(context),
                      ),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        const SummaryPanel(),
                        const SizedBox(height: 16),
                        _buildEnvSummaryButton(context),
                      ],
                    ),
                  ),
                ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(LucideIcons.lineChart, size: 16, color: AppColors.textTertiary),
  ...
  Widget _buildEnvSummaryButton(BuildContext context) {
    return Material(
      color: Colors.transparent,
      child: InkWell(
        onTap: () => _showEnvironmentalSummary(context),
        borderRadius: BorderRadius.circular(14),
        child: Container(
  ...
  void _showEnvironmentalSummary(BuildContext context) {
    showDialog(
      context: context,
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                  child: _DataCell(label: 'Dominant room condition', value: 'Quiet'),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _DataCell(label: 'Most frequent disturbance', value: 'Conversation'),
                ),
              ],
            ),
            ...
            Row(
              children: [
                Expanded(
                  child: _DataCell(label: 'Peak temperature', value: '26.4°C'),
                ),
                const SizedBox(width: 12),
                Expanded(
                  child: _DataCell(label: 'Noisy alerts recorded', value: '3'),
                ),
              ],
            ),
            ...
            const Text(
              'During the selected time range (1 Hour), the monitored environment was mostly in a Quiet condition. The most frequent disturbance was Conversation, with a peak temperature of 26.4°C and 3 noisy alerts recorded.',
            ...
            const SizedBox(height: 8),
            const Text(
              'Conditions were generally manageable, but recurring incidents suggest targeted reminders could further improve room discipline.',
              style: TextStyle(fontSize: 13, color: AppColors.textSecondary, height: 1.6),
            ),
